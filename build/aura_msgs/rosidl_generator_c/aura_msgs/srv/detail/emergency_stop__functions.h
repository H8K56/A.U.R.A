...
#ifndef AURA_MSGS__SRV__DETAIL__EMERGENCY_STOP__FUNCTIONS_H_
#define AURA_MSGS__SRV__DETAIL__EMERGENCY_STOP__FUNCTIONS_H_
 ...
 * calls
 * aura_msgs__srv__EmergencyStop_Request__init().
...
/**
 * It calls
 * aura_msgs__srv__EmergencyStop_Request__fini()
 ...
 * aura_msgs__srv__EmergencyStop_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * aura_msgs__srv__EmergencyStop_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * aura_msgs__srv__EmergencyStop_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aura_msgs
...
/**
 * It calls
 * aura_msgs__srv__EmergencyStop_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_aura_msgs
...
/**
 * It allocates the memory for the array and calls
 * aura_msgs__srv__EmergencyStop_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_aura_msgs
...
/**
 * It calls
 * aura_msgs__srv__EmergencyStop_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AURA_MSGS__SRV__DETAIL__EMERGENCY_STOP__FUNCTIONS_H_
