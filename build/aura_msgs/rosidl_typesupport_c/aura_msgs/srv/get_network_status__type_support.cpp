...
static const _GetNetworkStatus_Request_type_support_symbol_names_t _GetNetworkStatus_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aura_msgs, srv, GetNetworkStatus_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aura_msgs, srv, GetNetworkStatus_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aura_msgs, srv, GetNetworkStatus_Request)() {
  return &::aura_msgs::srv::rosidl_typesupport_c::GetNetworkStatus_Request_message_type_support_handle;
}
...
static const _GetNetworkStatus_Response_type_support_symbol_names_t _GetNetworkStatus_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aura_msgs, srv, GetNetworkStatus_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aura_msgs, srv, GetNetworkStatus_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, aura_msgs, srv, GetNetworkStatus_Response)() {
  return &::aura_msgs::srv::rosidl_typesupport_c::GetNetworkStatus_Response_message_type_support_handle;
}
...
static const _GetNetworkStatus_type_support_symbol_names_t _GetNetworkStatus_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aura_msgs, srv, GetNetworkStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aura_msgs, srv, GetNetworkStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, aura_msgs, srv, GetNetworkStatus)() {
  return &::aura_msgs::srv::rosidl_typesupport_c::GetNetworkStatus_service_type_support_handle;
}
