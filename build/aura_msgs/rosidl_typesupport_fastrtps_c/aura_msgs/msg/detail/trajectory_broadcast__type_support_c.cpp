...
#include "aura_msgs/msg/detail/trajectory_broadcast__rosidl_typesupport_fastrtps_c.h"
...
#include "builtin_interfaces/msg/detail/time__functions.h"  // start_time, timestamp
#include "geometry_msgs/msg/detail/point__functions.h"  // goal_position, waypoints
#include "rosidl_runtime_c/primitives_sequence.h"  // time_allocation
#include "rosidl_runtime_c/primitives_sequence_functions.h"  // time_allocation
...
using _TrajectoryBroadcast__ros_msg_type = aura_msgs__msg__TrajectoryBroadcast;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrajectoryBroadcast__ros_msg_type * ros_message = static_cast<const _TrajectoryBroadcast__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: time_allocation
  {
    size_t size = ros_message->time_allocation.size;
    auto array_ptr = ros_message->time_allocation.data;
    cdr << static_cast<uint32_t>(size);
  ...
  void * untyped_ros_message)
{
  ...
  _TrajectoryBroadcast__ros_msg_type * ros_message = static_cast<_TrajectoryBroadcast__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: time_allocation
  {
    ...
    if (ros_message->time_allocation.data) {
      rosidl_runtime_c__double__Sequence__fini(&ros_message->time_allocation);
    }
    if (!rosidl_runtime_c__double__Sequence__init(&ros_message->time_allocation, size)) {
      fprintf(stderr, "failed to create array for field 'time_allocation'");
      return false;
    }
    auto array_ptr = ros_message->time_allocation.data;
...
static uint32_t _TrajectoryBroadcast__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aura_msgs__msg__TrajectoryBroadcast(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aura_msgs__msg__TrajectoryBroadcast;
    is_plain =
      (
...
static size_t _TrajectoryBroadcast__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aura_msgs__msg__TrajectoryBroadcast(
...
static message_type_support_callbacks_t __callbacks_TrajectoryBroadcast = {
  "aura_msgs::msg",
  "TrajectoryBroadcast",
...
static rosidl_message_type_support_t _TrajectoryBroadcast__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrajectoryBroadcast,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aura_msgs, msg, TrajectoryBroadcast)() {
  return &_TrajectoryBroadcast__type_support;
}
