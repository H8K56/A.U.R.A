...
static rosidl_typesupport_introspection_c__MessageMember aura_msgs__msg__CoverageMap__rosidl_typesupport_introspection_c__CoverageMap_message_member_array[13] = {
  {
    "header",  // name
    ...
    offsetof(aura_msgs__msg__CoverageMap, header),  // bytes offset in struct
    NULL,  // default value
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, aura_msgs, msg, CoverageMap)() {
  ...
  aura_msgs__msg__CoverageMap__rosidl_typesupport_introspection_c__CoverageMap_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Time)();
  aura_msgs__msg__CoverageMap__rosidl_typesupport_introspection_c__CoverageMap_message_member_array[5].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Point)();
  aura_msgs__msg__CoverageMap__rosidl_typesupport_introspection_c__CoverageMap_message_member_array[10].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Point)();
