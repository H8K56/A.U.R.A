...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CoverageMap_message_member_array[13] = {
  {
    "header",  // name
    ...
    offsetof(aura_msgs::msg::CoverageMap, header),  // bytes offset in struct
