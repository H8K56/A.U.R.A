...
static const ::rosidl_typesupport_introspection_cpp::MessageMember NetworkMetrics_message_member_array[24] = {
  {
    "header",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(aura_msgs::msg::NetworkMetrics, mesh_connected),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
